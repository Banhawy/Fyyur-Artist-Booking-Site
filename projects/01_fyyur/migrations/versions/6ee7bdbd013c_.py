...
Revision ID: 6ee7bdbd013c
Revises: e91845ce436b
Create Date: 2020-10-13 11:06:40.690820
...
revision = '6ee7bdbd013c'
down_revision = 'e91845ce436b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.execute('DROP TABLE "Venue", "Artist", "Show" CASCADE')
